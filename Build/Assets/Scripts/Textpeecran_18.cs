...
public class Textpeecran_18 : MonoBehaviour
{
    public bool display = false;
    public bool displayInfo;
    public int x;
    public int y;
    string text = System.IO.File.ReadAllText("text_18.txt");
    ...
    void OnGUI()
    {
        ...
        {
            GUI.Box(new Rect(0, y, Screen.width, Screen.height), "Loggia", style_2);
