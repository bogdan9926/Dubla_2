...
public class Textpeecran_17 : MonoBehaviour
{
    public bool display = false;
    public bool displayInfo;
    public int x;
    public int y;
    string text = System.IO.File.ReadAllText("text_17.txt");
    ...
    void OnGUI()
    {
        ...
        {
            GUI.Box(new Rect(0, y, Screen.width, Screen.height), "Componente", style_2);
