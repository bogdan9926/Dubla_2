...
public class Textpeecran_36 : MonoBehaviour
{
    public bool display = false;
    public bool displayInfo;
    public int x;
    public int y;
    string text = System.IO.File.ReadAllText("text_36.txt");
    ...
    void OnGUI()
    {
        ...
        {
            GUI.Box(new Rect(0, y, Screen.width, Screen.height), "Biserica Principală", style_2);
