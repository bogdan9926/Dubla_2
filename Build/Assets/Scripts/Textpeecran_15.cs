...
public class Textpeecran_15 : MonoBehaviour
{
    public bool display = false;
    public bool displayInfo;
    public int x;
    public int y;
    string text = System.IO.File.ReadAllText("text_15.txt");
    ...
    void OnGUI()
    {
        ...
        {
            GUI.Box(new Rect(0, y, Screen.width, Screen.height), "Planul Palatului Potlogi", style_2);
