...
public class Textpeecran_6 : MonoBehaviour
{
    public bool display = false;
    public bool displayInfo;
    public int x;
    public int y;
    string text = System.IO.File.ReadAllText("text_6.txt");
    ...
    void OnGUI()
    {
        ...
        {
            GUI.Box(new Rect(0, y, Screen.width, Screen.height), "Nicolae Mavrocordat (1709 -1730) - domn fanariot", style_2);
